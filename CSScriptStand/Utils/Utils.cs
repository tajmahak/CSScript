...
{ /////
    ...
    public static bool CompareFiles(string file1Path, string file2Path) {
        ...
        string file1Hash = ToHex(__Utils_GetMD5HashFromFile(file1Path));
        string file2Hash = ToHex(__Utils_GetMD5HashFromFile(file2Path));
...
public class ScriptProcess : Process
{
    ...
    // Возврашает выходной поток ошибок
